...
const STAT_ROW_KEYS: {
  ...
  { titleKey: 'STAT_1_T', subtitleKey: 'STAT_1_S', descriptionKey: 'STAT_1_D' },
  { titleKey: 'STAT_2_T', subtitleKey: 'STAT_2_S', descriptionKey: 'STAT_2_D' },
  { titleKey: 'STAT_3_T', subtitleKey: 'STAT_3_S', descriptionKey: 'STAT_3_D' },
  { titleKey: 'STAT_4_T', subtitleKey: 'STAT_4_S', descriptionKey: 'STAT_4_D' },
];
...
export default function StatsSection() {
  ...
  const stats = STAT_ROW_KEYS.map((keys, index) => ({
